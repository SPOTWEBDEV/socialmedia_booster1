...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $stmt = $connection->prepare("
        SELECT id, service_id, order_name, naria_price, order_price, 
               order_category, social_url, message, quanity, order_id, 
               third_party_charge, profit, status, created_at, referral_bonus
        FROM user_orders
        WHERE id = ?
    ...
    if ($result->num_rows > 0) { ?>
        ...
        <form id="user-orders" class="section user-orders">
            <div class="info">
                <h6>User Orders</h6>
                ...
                <?php while ($order = $result->fetch_assoc()) { ?>
                    <div class="row mb-3">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="text-blacK">Order Name</label>
                                <input type="text" class="form-control text-black" value="<?php echo htmlspecialchars($order['order_name']); ?>" readonly>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="text-blacK">Service ID</label>
                                <input type="text" class="form-control text-black" value="<?php echo $order['service_id']; ?>" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-black" value="<?php echo $order['quanity']; ?>" readonly>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="text-blacK">Order Price In Naira</label>
                                <input type="text" class="form-control text-black" value="₦<?php echo number_format($order['naria_price'],2); ?>" readonly>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="text-blacK">Order Price Dollar</label>
                                <input type="text" class="form-control text-black" value="$<?php echo $order['order_price']; ?>" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="text-blacK">Third Party Charge</label>
                                <input type="text" class="form-control text-black" value="$<?php echo $order['third_party_charge']; ?>" readonly>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="text-blacK">Profit (Gain)</label>
                                <input type="text" class="form-control text-black" value="$<?php echo $order['profit']; ?>" readonly>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="text-blacK">Referral Bonus</label>
                                <input type="text" class="form-control text-black" value="₦<?php echo number_format($order['referral_bonus'],2); ?>" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-black" value="<?php echo htmlspecialchars($order['order_category']); ?>" readonly>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="text-blacK">Social URL</label>
                                <input type="text" class="form-control text-black" value="<?php echo htmlspecialchars($order['social_url']); ?>" readonly>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="text-blacK">Message</label>
                                <input type="text" class="form-control text-black" value="<?php echo htmlspecialchars($order['message']); ?>" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-black" value="<?php echo htmlspecialchars($order['status']); ?>" readonly>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="text-blacK">Order Date</label>
                                <input type="text" class="form-control text-black" value="<?php echo $order['created_at']; ?>" readonly>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="text-blacK">Order ID</label>
                                <input type="text" class="form-control text-black" value="<?php echo $order['order_id']; ?>" readonly>
                            </div>
                        </div>
                    </div>
