                    ...
                    <div class="account-content">
                        <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll"
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-8 col-lg-8 col-md-10 offset-md-2 layout-spacing">

                                    <form method="post" class="section about" enctype="multipart/form-data">
                                        <div class="info">
                            ...
                            if (isset($_POST['add_payment'])) {
                                ...
                                if ($type == 'crypto' && (!$wallet_name || !$wallet_address)) {
                                    echo "<script>toastr.error('Crypto wallet name and address required');</script>";
                                    exit;
                                }

                                if ($type == 'bank' && (!$bank_name || !$account_number || !$account_name)) {
                                    echo "<script>toastr.error('All bank fields required');</script>";
                                    exit;
                                }

                                if ($type == 'gateway' && !$gateway_name) {
                                    echo "<script>toastr.error('Gateway name required');</script>";
                                    exit;
                                }
                                ...
                                if ($type == 'crypto') {
                                    ...
                                    if (isset($_FILES['qr_code']) && $_FILES['qr_code']['error'] === 0) {
                                        ...
                                        if (!in_array($file_type, $allowed_types)) {
                                            echo "<script>toastr.error('Only PNG, JPG, JPEG, WEBP allowed');</script>";
                                            exit;
                                        }
                                        ...
                                        $target_file = $upload_dir . $qr_code_name;
...
");
                                ...
                                if ($stmt->execute()) {
                                    ...
                                    echo "<script>toastr.error('Failed to add payment method');</script>";
                                }
                            ...
                            if (isset($_GET['delete'])) {
                                ...
                                $stmt = $connection->prepare("DELETE FROM payment_methods WHERE id = ?");
            ...
            setTimeout(function() {
                window.location.href = './method.php';
                                    ...
                                    echo "<script>toastr.error('Delete failed');</script>";
                                }
                            ...
                            <div class="col-sm-12 card">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT * FROM payment_methods ORDER BY id DESC";
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            if ($row['type'] == 'crypto') {
                                                $details = "
                                                <strong>Wallet:</strong> {$row['wallet_name']} <br>
                                                <strong>Address:</strong> {$row['wallet_address']}
                                            ";
                                            } elseif ($row['type'] == 'bank') {
                                                $details = "
                                                <strong>Bank:</strong> {$row['bank_name']} <br>
                                                <strong>Acct No:</strong> {$row['account_number']} <br>
                                                <strong>Name:</strong> {$row['account_name']}
                                            ";
                                            } else {
                                                $details = "<strong>Gateway:</strong> {$row['gateway_name']}";
                                            }
    ...
    <tr>
        ...
        <td class='text-center'>
            <input type='checkbox' $checked 
                onchange=\"window.location='?toggle=$id&status=' + (this.checked ? 1 : 0)\">
        </td>
