...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/fi-icons@latest/css/fi.css">
...
if (isset($_POST['add_notification'])) {
    ...
    if ($icon === '' || $title === '') {
        echo "<script>toastr.error('Icon and Title are required');</script>";
    } else {
        $stmt = $connection->prepare(
            "INSERT INTO tutorial (icon, title, link) VALUES (?, ?, ?)"
        );
        $stmt->bind_param("sss", $icon, $title, $link);
        ...
        if ($stmt->execute()) {
            ...
            echo "<script>toastr.error('Failed to add notification');</script>";
        }
...
if (isset($_GET['del'])) {
    ...
    $stmt = $connection->prepare("DELETE FROM tutorial WHERE id = ?");
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>toastr.error('Failed to delete notification');</script>";
    }
                    ...
                    <div class="account-content">
                        <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll"
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 offset-md-3 layout-spacing">
                                <form class="section about card" method="post">
                                    <div class="info">
                                        <h5 class="">Add Tutorial Link</h5>
                                        ...
                                        <div class="row">
                                            <div class="col-md-11 mx-auto">
                                                ...
                                                <div class="form-group">
                                                    <label>Icon</label>
                                                    <select class="selectpicker form-control mb-4" name="icon" required data-live-search="true">
                                                        <option value="">Select Icon</option>
                                                        <option value="bi bi-person" data-content='<i class="bi bi-person"></i> Person'></option>
                                                        <option value="bi bi-check-circle" data-content='<i class="bi bi-check-circle"></i> Check'></option>
                                                        <option value="bi bi-key" data-content='<i class="bi bi-key"></i> Key'></option>
                                                        <option value="bi bi-lock" data-content='<i class="bi bi-lock"></i> Lock'></option>
                                                        <option value="bi bi-wallet2" data-content='<i class="bi bi-wallet2"></i> Wallet'></option>
                                                        <option value="bi bi-question-circle" data-content='<i class="bi bi-question-circle"></i> Question'></option>
                                                        <option value="bi bi-heart" data-content='<i class="bi bi-heart"></i> Heart'></option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label>Title</label>
                                                    <input type="text" class="form-control mb-4" name="title" placeholder="Enter notification title" required>
                                                </div>

                                                <div class="form-group">
                                                    <label>Link </label>
                                                    <input type="text" class="form-control mb-4" name="link" placeholder="Enter URL">
                                                </div>

                                                <div class="form-group">
                                                    <button class="btn btn-primary" name="add_notification">
                                                        Add Tutorial Link
                                                    </button>
                                                </div>
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0"
                                                aria-controls="default-ordering" rowspan="1" colspan="1"
                                                aria-label="ICON: activate to sort column ascending"
                                                style="width: 168.25px;">ICON</th>
                                            <th class="sorting" tabindex="0"
                                                aria-controls="default-ordering" rowspan="1" colspan="1"
                                                aria-label="TITLE: activate to sort column ascending"
                                                style="width: 111.922px;">TITLE</th>
                                            <th class="sorting" tabindex="0"
                                                aria-controls="default-ordering" rowspan="1" colspan="1"
                                                aria-label="LINK: activate to sort column ascending"
                                                style="width: 173.875px;">LINK</th>
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<tr role='row'>
                                                                        ...
                                                                        <td class='text-center'><a href='?del=$id' class='btn btn-danger'>Delete</a></td>
                                                                    </tr>";
                                        }
