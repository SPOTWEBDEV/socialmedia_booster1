                        ...
                        <div class="row">
                          ...
                          <form method="post" class="col-md-4 mx-auto">
                            <div class="form-group">
                              ...
                              <label for="acct_status">Suspension Message (if suspended)</label>
                              <input
                                name="status_message"
                                class="form-control mb-4"
                                value="<?php echo strip_tags($user['status_message']); ?>"
                                type="text" />
                            ...
                            if (isset($_POST['status_submit'])) {
                              ...
                              $update_statment = $connection->prepare("UPDATE users SET status = ? , status_message = ? WHERE id = ?");
                              $update_statment->bind_param("ssi", $acct_status, $status_message,  $user_id);
